...
Observer/Event, diagnostic, group, CEL, and dynamic definition/registry APIs are available but provisional during v0.x. Runtime replacement and telemetry APIs remain experimental until their owning releases. Internal representations are not public contracts.
